...
if __name__ == '__main__':
    ...
    argparser.add_argument('--modelpath', default='old_10cats_medroberta_updated')
    argparser.add_argument('--model_name', default='old_10cats_medroberta_updated')
    args = argparser.parse_args()

    data_pkl = "./data/combined_test_new_INS_fixed_FP.pkl"
    model_name = "old_10cats_medroberta_updated"
    model_type = 'roberta'
